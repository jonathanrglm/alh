    ...
    return (
        <div className="container">
            ...
            <div className="row mb-4">
                ...
                <div className="col-sm-8 col-md-9 col-lg-6">
                    Yo quería seguir hablando con ella y así fue, hablamos por Messenger, por WhatsApp y en algún momento hasta por Instagram, gracias a ello la fui conociendo poco a poco, siendo así que llegó el punto en que me dijo que tenía un bebé yo estaba en modo de negación no le creía mi mente decía neee no le creas las matemáticas no mienten, pero algo mencionó sobre unas fotos en Facebook y al investigar dentro del mismo encontré una foto donde realmente parecía la mamá de una niña mi mente entro en un modo de crasheo donde estaba entre sí era verdad o mentira?? al caer la noche, por necesidad nos despedimos.
                </div>
                <div className="col-sm-4 col-md-3 col-lg-3">
            ...
            <div className="row mb-4">
                ...
                <div className="col-sm-8">
                    Tiempo después la volví a ver en el Servicio Social estando ahí todos estábamos conversando volviendo a reír como locos, pero llego el momento en que pregunte... ”Enserio tienes una niña??“Su respuesta fue si, la respuesta de sus amigos fue si, y por flojera de no preguntar a picazo, en mi mente dije “créelo tiene una niña” fue así como de Rayos!! al parecer un sentimiento por ella estaba naciendo en mí y a pesar de ese Rayos dije “no hay problema me gusta y quiero conocerla”. Posteriormente a ello, todos habíamos quedado en salir a algún lugar a cotorrear y así crear o fortalecer la amistad que teniamos, el día quedo acordado para el viernes y el destino fue las hamburguesas. Finalmente, la hora de labores volvió a llegar a su fin y nos despedimos.
                </div>
            </div>
                ...
                <div className="col-sm-6 col-md-9 my-auto" style={{ padding: 0 }}>
                    <div className="row">
                        <div className="col-md-12 col-lg-12 pt-3">
                            <p>Las conversaciones por redes sociales continuaban siendo interminables, quizá llego al punto en que se enfado de tanto que hablaba o en este caso escribía, pero a pesar de ello me seguía respondiendo de un momento a otro me anime a pedirle una foto de ella, queria tenerla en mi celular y poder verla cada vez que yo quisiera, pensé que se negaría y así fue, me costo mucho rogar hasta que finalmente la convencí, eso o de plano la arte y dijo ten!! Ya cállate jajaja</p>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-12 col-lg-12">
                            <p>Los días seguían pasando, las conversaciones fluyendo, me sentía en las nubes era la primera vez que hablaba con una chica tan hermosa y que a pesar de todo ella seguía mis conversaciones, mis cotorreos, mis chistes ella era única, estaba decidido a tener algo más que solo una amistad con ella de tal forma que en algún momento elabore un regalo que al principio dije “esta fácil”, pero a partir de esa experiencia aprendí que la cartulina y la papiroflexia no se llevan muy bien o de plano necesitas basta paciencia, eso si, el resultado esperado fue el deseado porque al parecer si le gusto :D y eso me alegro mucho. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row m-0 p-0 mb-4">
                ...
                <div className="col-sm-6 col-md-8 col-lg-8 my-auto">
                    Desafortunadamente,  ya no iba a poder ir al Servicio tan continuamente debido a que entre a un curso, desde ahí el poder verla se fue complicando un poco, mi única manera de poder estar en contacto con ella era por las redes sociales mediante su chat, en ocasiones cuando tenia oportunidad de ir, iba esperanzado con verla, pero queria que fuese una sorpresa, por ello, nunca le avise cuando iba, quizá, si lo hubiese hecho otra cosa habría sido.
                    </div>
                <div className="col-sm-3 col-md-2 col-lg-2 my-auto" >
